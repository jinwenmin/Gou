...
public class TeamZBJLActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    @BindView(R.id.TeamZBJLtimetext4)
    TextView TeamZBJLtimetext4;
    @BindView(R.id.TeamZBJLgameLotteryType4)
    Spinner TeamZBJLgameLotteryType4;
    @BindView(R.id.TeamZBJLrelateBank4)
    RelativeLayout TeamZBJLrelateBank4;
