...
public class TeamCunQuActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    @BindView(R.id.TeamCunQutimetext4)
    TextView TeamCunQutimetext4;
    @BindView(R.id.TeamCunQuLotteryType4)
    Spinner TeamCunQuLotteryType4;
    @BindView(R.id.TeamCunQurelateBank4)
    RelativeLayout TeamCunQurelateBank4;
    @BindView(R.id.TeamCunQutimetext3)
    TextView TeamCunQutimetext3;
    @BindView(R.id.TeamCunQuLotteryType)
    Spinner TeamCunQuLotteryType;
    @BindView(R.id.imageView)
    ImageView imageView;
    @BindView(R.id.TeamCunQurelateBank3)
    RelativeLayout TeamCunQurelateBank3;
